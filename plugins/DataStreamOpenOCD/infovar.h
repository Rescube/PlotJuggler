...
private:
  ...
  void BuildVarList(const QString & paramString1, const QString & paramString2, const QString & paramString3, bool parambool);
  void ExtractIdentifier(const QString & paramString1, const QString & paramString2, const QString & paramString3, bool parambool);
